        ...
        <div className="flex flex-col justify-center gap-2 lg:flex-row">
          ...
          <div className="w-full px-4 py-4 lg:py-12 lg:w-1/2 font-poppins">
            <div className="relative flex items-center gap-2 text-xl font-normal z-1 ">
              <p className="text-teal-400 ">Hi!</p>
              <p className="text-zinc-400">About Me</p>
              <span class="flex items-center absolute -bottom-4 transform -rotate-3">
                <span class="w-32 h-0.5 bg-teal-400"></span>
                <span class="w-4 -ml-4 h-4 border-teal-400 border-t-4 border-r-2 transform rotate-45"></span>
              </span>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-sm dark:text-zinc-400">
                ...
                experience in frontend development, which enriches my ability to
